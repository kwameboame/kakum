$(function() {
    ...
    var sparker = function() {
        ...
        // Discrete charts
        $('#discrete1').sparkline('html', { type: 'discrete', lineColor: '#780E1A', xwidth: 18 });
        $('#discrete2').sparkline('html', { type: 'discrete', lineColor: '#780E1A', thresholdColor: '#ff5722', thresholdValue: 4 });
